    ...
    <nav class="h-24 bg-slate-800 text-white">
        <div class=" mx-28 flex justify-between items-center p-2">
            ...
            <ul class="flex font-semibold hover">
                ...
                <li class="px-6 text-xl p-3"><a href="/blogs">About</a></li>
                <li class="px-6 text-xl p-3"><a href="">Services</a></li>
                ...
                <div class="px-4">
                    <ul class="flex font-bold">
                        ...
                        <li class="px-4 text-4xl">
                            <a href="bookings" class="text-sm border border-blue-800 hover:bg-blue-500 px-5 p-3 rounded-lg flex items-center">
                                <span class="material-symbols-outlined"">
                                        edit_square
                                    </span>
                                    <p class=" pl-1">Appoinments</p>
                            </a>
                        </li>
